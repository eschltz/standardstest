...
- [ ]   empirically evaluates the proposed artifact using:  
  [action research](https://github.com/eschltz/standardstest/blob/main/docs/standards/ActionResearch.md), in which the researchers intervene in a real organization using the artifact,  
  a [case study](https://github.com/eschltz/standardstest/blob/main/docs/standards/CaseStudy.md) in which the researchers observe a real organization using the artifact,  
  a [controlled experiment](https://github.com/eschltz/standardstest/blob/main/docs/standards/Experiments.md) in which human participants use the artifact,  
  a [quantitative simulation](https://github.com/eschltz/standardstest/blob/main/docs/standards/QuantitativeSimulation.md) in which the artifact is assessed (usually against a competing artifact) in an artificial environment,  
  a [benchmarking study](https://github.com/eschltz/standardstest/blob/main/docs/standards/Benchmarking.md), in which the artifact is assessed using one or more benchmarks, or  
