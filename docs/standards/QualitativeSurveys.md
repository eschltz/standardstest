...
- [ ]	explains how interviewees were selected (see the [Sampling Supplement](https://github.com/eschltz/standardstest/blob/main/docs/supplements/Sampling.md))
...
- [ ]	uses multiple coders and analyzes inter-coder reliability (see [IRR/IRA Supplement](https://github.com/eschltz/standardstest/blob/main/docs/supplements/InterRaterReliabilityAndAgreement.md))
</checklist>
...
**transferability** (see [Glossary](https://github.com/eschltz/standardstest/blob/main/docs/supplements/Glossary.md)). Quantitative quality criteria
