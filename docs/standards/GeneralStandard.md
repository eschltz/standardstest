...
- [ ]	describes in detail what, where, when and how data were collected (see the [Sampling Supplement](https://github.com/eschltz/standardstest/blob/main/docs/supplements/Sampling.md))
...
- [ ]	acknowledges and mitigates potential risks, harms, burdens or unintended consequences of the research (see the ethics supplements for [Engineering Research](https://github.com/eschltz/standardstest/blob/main/docs/supplements/EthicsEngineering.md), [Human Participants](https://github.com/eschltz/standardstest/blob/main/docs/supplements/EthicsHumanParticipants.md), or [Secondary Data](https://github.com/eschltz/standardstest/blob/main/docs/supplements/EthicsSecondaryData.md))
- [ ]	visualizations/graphs are not misleading (see the [Information Visualization Supplement](https://github.com/eschltz/standardstest/blob/main/docs/supplements/InformationVisualization.md))
...
- [ ]   publishes the study in two phases: a plan and the results of executing the plan (see the [Registered Reports Supplement](https://github.com/eschltz/standardstest/tree/main/docs/supplements)) 
- [ ]	uses multiple raters, where philosophically appropriate, for making subjective judgments (see the [IRR/IRA Supplement](https://github.com/eschltz/standardstest/blob/main/docs/supplements/InterRaterReliabilityAndAgreement.md))
...
- [ ]	applies two or more data collection or analysis strategies to the same research question (see the [Multimethodology Standard](https://github.com/eschltz/standardstest/blob/main/docs/standards/MixedMethods.md))
