	...
	for(let line of lines){
		...
		if (line_text != ""){
			...
			if(line_text.includes("footnote")) {
				console.log("DEBUG2: Creating tooltip");
				checklistItemText = createTooltip(checklistItemText, line_text, footnotes);
			} else {
				console.log("DEBUG3: Did not create tooltip");
